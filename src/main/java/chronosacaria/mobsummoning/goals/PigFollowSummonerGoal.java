...
public class PigFollowSummonerGoal extends Goal {

    private final SummonedPigEntity summonedEntity;
    ...
    public PigFollowSummonerGoal(SummonedPigEntity summonedEntity, LivingEntity summoner, WorldView worldView,
