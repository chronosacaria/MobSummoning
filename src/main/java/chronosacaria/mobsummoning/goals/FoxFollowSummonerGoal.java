...
public class FoxFollowSummonerGoal extends Goal {

    private final SummonedFoxEntity summonedEntity;
    ...
    public FoxFollowSummonerGoal(SummonedFoxEntity summonedEntity, LivingEntity summoner, WorldView worldView,
