...
public class LlamaFollowSummonerGoal extends Goal {

    private final SummonedLlamaEntity summonedEntity;
    ...
    public LlamaFollowSummonerGoal(SummonedLlamaEntity summonedEntity, LivingEntity summoner, WorldView worldView,
