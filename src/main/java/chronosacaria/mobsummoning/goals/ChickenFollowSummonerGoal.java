...
public class ChickenFollowSummonerGoal extends Goal {

    private final SummonedChickenEntity summonedEntity;
    ...
    public ChickenFollowSummonerGoal(SummonedChickenEntity summonedEntity, LivingEntity summoner, WorldView worldView,
