...
public class SheepFollowSummonerGoal extends Goal {

    private final SummonedSheepEntity summonedEntity;
    ...
    public SheepFollowSummonerGoal(SummonedSheepEntity summonedEntity, LivingEntity summoner, WorldView worldView,
