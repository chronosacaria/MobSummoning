...
public class SpiderFollowSummonerGoal extends Goal {

    private final SummonedSpiderEntity summonedEntity;
    ...
    public SpiderFollowSummonerGoal(SummonedSpiderEntity summonedEntity, LivingEntity summoner, WorldView worldView,
