...
public class RabbitFollowSummonerGoal extends Goal {

    private final SummonedRabbitEntity summonedEntity;
    ...
    public RabbitFollowSummonerGoal(SummonedRabbitEntity summonedEntity, LivingEntity summoner, WorldView worldView,
