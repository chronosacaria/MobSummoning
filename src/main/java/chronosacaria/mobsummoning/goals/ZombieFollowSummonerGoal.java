...
public class ZombieFollowSummonerGoal extends Goal {

    private final SummonedZombieEntity summonedEntity;
    ...
    public ZombieFollowSummonerGoal(SummonedZombieEntity summonedEntity, LivingEntity summoner, WorldView worldView,
