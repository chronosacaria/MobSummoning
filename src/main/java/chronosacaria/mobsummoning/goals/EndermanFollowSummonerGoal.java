...
public class EndermanFollowSummonerGoal extends Goal {

    private final SummonedEndermanEntity summonedEntity;
    ...
    public EndermanFollowSummonerGoal(SummonedEndermanEntity summonedEntity, LivingEntity summoner, WorldView worldView,
