...
public class SkeletonFollowSummonerGoal extends Goal {

    private final SummonedSkeletonEntity summonedEntity;
    ...
    public SkeletonFollowSummonerGoal(SummonedSkeletonEntity summonedEntity, LivingEntity summoner, WorldView worldView,
