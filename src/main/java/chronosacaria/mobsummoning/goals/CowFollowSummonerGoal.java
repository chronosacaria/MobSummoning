...
public class CowFollowSummonerGoal extends Goal {

    private final SummonedCowEntity summonedEntity;
    ...
    public CowFollowSummonerGoal(SummonedCowEntity summonedEntity, LivingEntity summoner, WorldView worldView,
