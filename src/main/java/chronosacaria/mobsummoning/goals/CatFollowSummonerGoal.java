...
public class CatFollowSummonerGoal extends Goal {

    private final SummonedCatEntity summonedEntity;
    ...
    public CatFollowSummonerGoal(SummonedCatEntity summonedEntity, LivingEntity summoner, WorldView worldView,
