...
public class BatFollowSummonerGoal extends Goal {

    private final SummonedBatEntity summonedEntity;
    ...
    public BatFollowSummonerGoal(SummonedBatEntity summonedEntity, LivingEntity summoner, WorldView worldView,
