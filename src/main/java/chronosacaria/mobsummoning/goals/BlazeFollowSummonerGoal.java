...
public class BlazeFollowSummonerGoal extends Goal {

    private final SummonedBlazeEntity summonedEntity;
    ...
    public BlazeFollowSummonerGoal(SummonedBlazeEntity summonedEntity, LivingEntity summoner, WorldView worldView,
