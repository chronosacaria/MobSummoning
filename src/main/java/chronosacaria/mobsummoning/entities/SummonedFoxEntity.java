...
import chronosacaria.mobsummoning.goals.FoxFollowSummonerGoal;
...
public class SummonedFoxEntity extends FoxEntity implements ISummonable {

    protected static final TrackedData<Optional<UUID>> SUMMONER_UUID;

    public SummonedFoxEntity(EntityType type, World world){
    ...
    protected void initGoals(){
        ...
        this.goalSelector.add(6, new FoxFollowSummonerGoal(this, this.getSummoner(), this.world, 1.0,
    ...
    static {
        SUMMONER_UUID = DataTracker.registerData(SummonedFoxEntity.class,
