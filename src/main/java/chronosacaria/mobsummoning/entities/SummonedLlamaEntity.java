...
public class SummonedLlamaEntity extends LlamaEntity implements ISummonable {

    protected static final TrackedData<Optional<UUID>> SUMMONER_UUID;

    public SummonedLlamaEntity(EntityType type, World world){
    ...
    static {
        SUMMONER_UUID = DataTracker.registerData(SummonedLlamaEntity.class,
