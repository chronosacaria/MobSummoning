...
public class SummonedRabbitModel<T extends SummonedRabbitEntity> extends EntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
        if (this.child) {
            ...
            ImmutableList.of(this.leftFoot, this.rightFoot, this.leftBackLeg, this.rightBackLeg, this.torso, this.leftFrontLeg, this.rightFrontLeg, this.tail).forEach((modelPart) -> {
                modelPart.render(matrices, vertices, light, overlay, red, green, blue, alpha);
            });
            matrices.pop();
        } else {
            ...
            ImmutableList.of(this.leftFoot, this.rightFoot, this.leftBackLeg, this.rightBackLeg, this.torso, this.leftFrontLeg, this.rightFrontLeg, this.head, this.rightEar, this.leftEar, this.tail, this.nose).forEach((modelPart) -> {
                modelPart.render(matrices, vertices, light, overlay, red, green, blue, alpha);
            });
            matrices.pop();
        }
