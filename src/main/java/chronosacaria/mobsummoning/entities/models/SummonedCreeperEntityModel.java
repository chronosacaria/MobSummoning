...
public class SummonedCreeperEntityModel<T extends Entity> extends CompositeEntityModel<T> {
    ...
    public SummonedCreeperEntityModel() {
        this(0.0F);
    }

    public SummonedCreeperEntityModel(float scale) {
