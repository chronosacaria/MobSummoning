...
public class SummonedRavagerEntityModel extends CompositeEntityModel<SummonedRavagerEntity> {
    ...
    public void setAngles(SummonedRavagerEntity ravagerEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(SummonedRavagerEntity ravagerEntity, float f, float g, float h) {
