...
public class SummonedHorseEntityModel<T extends SummonedHorseEntity> extends AnimalModel<T> {
    ...
    public SummonedHorseEntityModel(float scale) {
    ...
    public void setAngles(T horseBaseEntity, float f, float g, float h, float i, float j) {
        ...
        ModelPart[] var9 = this.field_3304;
