...
import chronosacaria.mobsummoning.goals.CowFollowSummonerGoal;
...
public class SummonedCowEntity extends CowEntity implements ISummonable {

    protected static final TrackedData<Optional<UUID>> SUMMONER_UUID;

    public SummonedCowEntity(EntityType type, World world){
    ...
    protected void initGoals(){
        ...
        this.goalSelector.add(6, new CowFollowSummonerGoal(this, this.getSummoner(), this.world, 1.0,
    ...
    static {
        SUMMONER_UUID = DataTracker.registerData(SummonedCowEntity.class,
