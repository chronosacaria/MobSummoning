...
public class SummonedSpiderEntity extends SpiderEntity implements ISummonable {

    protected static final TrackedData<Optional<UUID>> SUMMONER_UUID;

    public SummonedSpiderEntity(EntityType type, World world){
    ...
    protected void initGoals(){
        ...
        this.goalSelector.add(6, new SpiderFollowSummonerGoal(this, this.getSummoner(), this.world, 1.0,
    ...
    public boolean tryAttack(Entity target) {
        ...
        if (bl) {
            ...
            this.playSound(SoundEvents.ENTITY_SPIDER_AMBIENT, 1f,
    ...
    static {
        SUMMONER_UUID = DataTracker.registerData(SummonedSpiderEntity.class,
