...
public class SummoningHelper {
    // Passive Mobs
    public static void summonBat (LivingEntity entity, BlockPos blockPos){
    ...
    public static void summonCat (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonChicken (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonCow (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonFox (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonPig (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonRabbit (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonSheep (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    // Neutral Mobs
    public static void summonEnderman (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonIronGolem (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonLlama (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonSpider (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonWolf (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    // Hostile Mobs
    public static void summonBlaze (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
    ...
    public static void summonSkeleton (LivingEntity entity, BlockPos blockPos){
        World world = entity.getEntityWorld();
